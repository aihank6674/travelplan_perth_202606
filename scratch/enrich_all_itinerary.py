...
def main():
    ...
    { 
        ...
        location: "Kalbarri", 
        type: "roadtrip", 
        stay: "Murchison View Apartments", 
        ...
        activities: [
            ...
            {time:"16:30", title:"入住卡尔巴里酒店", icon:"fa-bed", note:"抵达卡尔巴里并入住 Murchison View Apartments。酒店地理位置极佳，马路对面就是静谧的默奇森河，可以稍微整理行李并休息，消除行车疲劳。"},
    ...
    { 
        ...
        activities: [
            ...
            {time:"16:30", title:"Check in at Kalbarri", icon:"fa-bed", note:"Check in at Murchison View Apartments. Take a rest. The hotel is opposite the Murchison River where you can watch pelicans and sunsets."},
